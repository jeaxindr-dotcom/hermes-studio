  ...
  try {
    ...
    const started = await bridge.chat(
      ...
      profile,
      {
        ...
        ...(data.chat_template_kwargs ? { chat_template_kwargs: data.chat_template_kwargs } : {}),
      },
    )
