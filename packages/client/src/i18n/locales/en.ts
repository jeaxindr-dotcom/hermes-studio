export default {
  ...
  activity: {
    ...
    agents: 'Subagents',
    progress: 'Progress',
    delegationRoot: 'Main delegation',
    agent: 'Agent {index}',
    noTasks: 'No tasks for this session',
    noAgents: 'No subagents for this session',
    running: 'Running',
    completed: 'Completed',
    failed: 'Failed',
    cancelled: 'Cancelled',
  ...
  code: {
    ...
    assistantSearchHistory: 'Search conversations…',
    assistantNoChat: 'No active conversation. Create one to work with Hermes in this project.',
    showAssistant: 'Show assistant',
    hideAssistant: 'Collapse assistant',
  },
  ...
  chat: {
    ...
    newChat: 'New Chat',
    resizeSidebar: 'Resize the Discussion sidebar',
    projects: 'Projects',
    projectEmpty: 'No conversations yet',
    projectActions: 'Project actions',
    projectUpdated: 'Conversation moved to project',
    category: 'Project',
    uncategorized: 'No project',
    categoryPlaceholder: 'Select or create a project',
    categoryCreateHint: 'Enter a name and press Enter.',
    categoryCreated: 'Project "{name}" created',
    projectCreated: 'Project "{name}" created',
    newProject: 'New project',
    newProjectName: 'Project name',
    categoryCreateFailed: 'Failed to create the project',
    categoryLoadFailed: 'Failed to load projects',
    moveToCategory: 'Move to project',
    categoryUpdated: 'Project updated',
    categoryUpdateFailed: 'Failed to update the project',
    renameCategory: 'Rename project',
    deleteCategory: 'Delete project',
    enterCategoryName: 'Enter the project name',
    confirmDeleteCategory: 'Delete "{name}"? Its sessions will move to No project.',
    categoryRenamed: 'Project renamed',
    categoryRenameFailed: 'Failed to rename the project',
    categoryDeleted: 'Project deleted',
    categoryDeleteFailed: 'Failed to delete the project',
    agent: 'Agent',
