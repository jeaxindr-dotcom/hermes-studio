        ...
        <div v-if="queuedMessages.length > 0" class="queue-float-panel">
          <div class="queue-float-header">
            ...
            <NButton
              ...
              :title="canSteerQueuedMessages ? t('chat.steer') : t('chat.steerUnavailable')"
              :aria-label="canSteerQueuedMessages ? t('chat.steer') : t('chat.steerUnavailable')"
              @click.stop="canSteerQueuedMessages && requestSteering(queuedMessages[0])"
            >
              <template #icon>
